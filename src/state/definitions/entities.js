...
export const entities = {
  ...
  // Cards
  LA: { type: 'door2',    text: [ "Der böse Zauberer ist vor wenigen Tagen auf seinem Kamel mit der Prinzessin fortgeritten. Vielleicht kann Dir das Kamel weiterhelfen. Suche das Kamel in den Kakteen in der Wüste.", "Der Zauberer ist auf seinem Kamel forgeritten und mit seinem Boot zur Kakteeninsel gefahren. Vielleicht kann Dir das Kamel weiterhelfen. Suche das Kamel auf der Kakteeninsel.", "Die Prinzessin ist im Schlangengehege versteckt." ] },
